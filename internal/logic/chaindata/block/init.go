...
var abi721 abi.ABI
var event721 abi.Event

// var transferTopic string = "0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"
var abi1155 abi.ABI
var event1155signal abi.Event
var event1155mul abi.Event
...
func init() {
	...
	////
	a, err = abi.JSON(strings.NewReader(abiData721))
	if err != nil {
		panic(err)
	}
	abi721 = a
	event721 = abi721.Events[transferName]
	//
	////
	...
	abi1155 = a
	event1155signal = abi1155.Events[signTransfer]
